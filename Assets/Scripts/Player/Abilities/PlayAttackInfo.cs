...
public class PlayAttackInfo
{
    ...
    [SerializeField]
    [Tooltip("The button press that will use this attack. This button must be in input settings")]
    ...
    [SerializeField]
    [Tooltip("The pregab game object representing the ability")]
